...
namespace Opgavesæt4.Controllers
{
    public class AlbumsController : Controller
    {
        ...
        {
            var applicationDbContext = _context.Albums.Include(a => a.Artist).Include(a => a.Genre).Include(s => s.Songs);
        ...
        public async Task<IActionResult> Create([Bind("Id,Title,Price,AlbumArtUrl,GenreId,ArtistId")] Album album)
        {
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            var album = await _context.Albums.Include(s => s.Songs).FirstOrDefaultAsync(x => x.Id == id);
            if (album == null)
            {
                return NotFound();
            }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Title,Price,AlbumArtUrl,GenreId,ArtistId")] Album album)
        {
            if (id != album.Id)
            {
                return NotFound();
